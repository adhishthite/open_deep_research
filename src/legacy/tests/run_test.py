...
def main():
    ...
    parser.add_argument(
        "--supervisor-model",
        help="Model for supervisor agent (e.g., 'anthropic:claude-3-7-sonnet-latest')",
    )
    parser.add_argument(
        "--researcher-model",
        help="Model for researcher agent (e.g., 'anthropic:claude-3-5-sonnet-latest')",
    )
    parser.add_argument(
        "--planner-provider", help="Provider for planner model (e.g., 'anthropic')"
    )
    parser.add_argument(
        "--planner-model",
    ...
    parser.add_argument(
        "--writer-provider", help="Provider for writer model (e.g., 'anthropic')"
    )
    parser.add_argument(
        "--writer-model",
        help="Model for writer in graph-based agent (e.g., 'claude-3-5-sonnet-latest')",
    )
    parser.add_argument(
        "--eval-model",
