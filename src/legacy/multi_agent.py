"""Legacy multi-agent research implementation."""
...
from legacy.prompts import RESEARCH_INSTRUCTIONS, SUPERVISOR_INSTRUCTIONS
...
class ReportStateOutput(MessagesState):
    """Output state for the multi-agent report generation."""
...
class SectionState(MessagesState):
    """State for individual section generation in the multi-agent workflow."""
